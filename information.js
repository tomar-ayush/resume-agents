...
const email = "ayushtomar8624@gmail.com";
const password = "Onlyleg@l1"; // Most applications require 8 characters (some require 16), a capital letter, a numeric character, and a special character
...
module.exports = {
    email, password, fullName, firstName, lastName, suffix, street, city, state, postalCode, phoneType, phoneNumber, workexperiences, school, degree, fieldOfStudy, gpa, skills, startDate, endDate, resumeFilePath, linkedInLink, githubLink, gender, ethnicity, hispanicOrLatino, veteranStatus, disability,
};